class BoxShadowGenerator {
    ...
    applyRule() {
        ...
        const shadowRule = `${this.insetRef ? "inset" : ""} ${this.horizontalRef.value}px ${this.verticalRef.value}px ${this.spreadRef.value}px ${this.blurRef.value}px rgba(${rgbValue},${this.opacityRef.value}) `;
...
inset.addEventListener("input", (e) => {
  ...
  const copyInstructions = document.querySelector("#copy");
